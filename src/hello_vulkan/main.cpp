...
class HelloTriangleApplication : public WindowVulkan{
public:
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), spin * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.proj = glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float) swapChainExtent.height, 0.1f, 10.0f);
        ubo.proj[1][1] *= -1;
        //TODO ubo.proj = ubo.proj * ubo.view * ubo.model;
...
using namespace tinygltf;
    ...
    bool ret = loader.LoadASCIIFromFile(&model, &err, &warn, "models/FlightHelmet/glTF/FlightHelmet.gltf");
